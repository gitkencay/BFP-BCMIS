            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            <li class="active"><a href="Distress-FireRespondents.html"><span class="fa fa-align-justify"></span> Fire Stations Respondents</a></li>
                             ...
                             <div class="panel panel-default">
                                 <div class="panel-heading">
                                     ...
                                     <ul class="panel-controls">
                                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#View-SMS-Alert"><i class="fa fa-warning"></i>SMS Alert</button>
                                         </div>
                                 </div>
                                     ...
                                     <table class="table datatable" id="dataTables-example-emp">
                                         ...
                                         <tbody>
                                             <tr>
                                                 ...
                                                 <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#View-Employee-Reg"><i class="fa fa-eye"></i> View</button></td>
                                                 <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#View-Employee-Reg"><i class="fa fa-truck"></i> Respond</button></td>
                                             </tr>
                                             <tr>
        ...
        <!--Start modal view sms alert-->
           <div id="Message-Alert" class="modal fade">
                                             ...
                                             <!--End modal view sms alert-->
                                              ...
                                              <!--Start Modal View table sms-->
                                         <div class="modal fade" id="View-SMS-Alert" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                             <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                  <h3 class="modal-title">SMS List</h3>
                                                        </div>
