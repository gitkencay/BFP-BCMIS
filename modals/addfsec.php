        <div class="modal fade" id="FSEC-Reg" role="dialog">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        $query = $conn->query("select * from `fsec_application` order by application_no DESC limit 1") or die(mysqli_error());
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="brgy-no" name="barangay">
                                                ...
                                                <option value="1">Brgy.2</option>
                                                <option value="1">Brgy.3</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="date" class="form-control" id="date" name="date">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <label><input type="checkbox" value="Endorsement from building Official" name="initial_requirements[]">&nbsp;Endorsement from building Official</label>
                                            <label><input type="checkbox" value="Set of Building Plans (3)" name="initial_requirements[]">&nbsp;Set of Building Plans (3)</label>
                                            <label><input type="checkbox" value="Bill of Materials and Cost Estimate (1)" name="initial_requirements[]">&nbsp;Bill of Materials and Cost Estimate (1)</label>
                                            <label><input type="checkbox" value="FALAR-1 (3)" name="initial_requirements[]">&nbsp;FALAR-1 (3)</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
