        ...
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <h3 class="modal-title">Pending List(FSEC Assessment)</h3>
                        </div>
...
$query = $conn->query("select * from `application` where assessment_status = 'Unassessed' && status = 'Complete' && application_type = 'FSEC'") or die(mysqli_error());
