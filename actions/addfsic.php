...
if(isset($_POST['submit'])){
    ...
    $conn->query("INSERT INTO `fsic_application` VALUES('', '$application_name', '$business_name', '$establishment_address', '$building_type', '$barangay', '$type_of_permit', '$date_applied', '$username', '$password', '$owner_name', '$number_of_floors', '$lot_size', '$status', '$month', '$year')") or die(mysqli_error());
    $conn->close();
